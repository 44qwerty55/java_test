...
public class MailHelper {
  ...
  // Ожидание почтового сообщения count - кол-во писем , timeout - время ожидания
  ...
  public static MailMessage toModelMail(WiserMessage m) {
    try {
      ...
      // Для входящего сообщения получаем список получателей отбираем первого из них, так как известно, что получатель единственный
